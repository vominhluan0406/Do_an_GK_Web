str = ['An Giang','Bà Rịa - Vũng Tàu','Bắc Giang','Bắc Kạn','Bạc Liêu',
...
'Phú Thọ','Quảng Bình','Quảng Nam','Quảng Ngãi','Quảng Ninh','Quảng Trị','Sóc Trăng','Sơn La','Tây Ninh',
...
$(document).ready(function(){
    for(i=0;i<str.length;i++){
        ...
        $('#shipping_country').append('<option value="' + i + '">' + str[i] + '<\/option>');
    }
});